...
console.log(this.eat()); //first it will search the method in dog class if found then it will call chcildern class if npot found then it will search in parent class